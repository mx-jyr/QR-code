...
<Project
    ...
    <Project
      name="暂存商店，旧物的温暖港湾"
      description="当你即将毕业，需要离校但转手的商品还没找到新主人，别着急，暂存商店将为君排忧解难，
      该商店是鸿德易物栈与学校合作设立的线下门店，它就像一位贴心的老友，为你想卖出但又不便带走的商品提供了一个温暖的“家”，
      将不便带走的二手好物上架在平台上，物品放至暂存商店即可放心离校，有购买需求的学生在付款后凭借平台购买记录去暂存商店即可拿到心仪好物。"
      link="/"
      img={{
        src: '/assets/images/暂存商店.png',
        alt: 'Project Web Design',
      }}
      category={
        <>
          <Tags color={ColorTags.ROSE}>毕业离校</Tags>
          <Tags color={ColorTags.SKY}>转手商品</Tags>
          <Tags color={ColorTags.FUCHSIA}>上架平台</Tags>
